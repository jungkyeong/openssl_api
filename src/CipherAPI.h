/**
  ...
  */
  ...
  #define ALG_ARIA128 0
  #define ALG_ARIA192 2
  #define ALG_ARIA256 3
  #define ALG_AES128 4
  #define ALG_AES192 5
  #define ALG_AES256 6
  ...
  public:
    ...
    */
    int hash_make_value(char* data, unsigned char* hashed, int hash_buf_max_size, int type);
    ...
    */
    int enc_sym_data(const char* data, unsigned char* key, unsigned char* iv, int type, unsigned char* enc_buf, int max_buf_size);
    ...
    */
    int dec_sym_data(unsigned char* enc_buf, int enc_buf_len, unsigned char* key, unsigned char* iv, int type, unsigned char* dec_buf, int max_buf_size);
    ...
    */ 
    int pbkdf_key_generate(const char* password, unsigned char* salt, int salt_len, unsigned char* key, int key_len);
    ...
    * @return Success: 0 Fail -1
    */
    int generate_rand_data(unsigned char* data, int len);
